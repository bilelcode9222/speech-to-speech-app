...
export function privacyPage(): string {
  return page(
    ...
    <p><strong>Événements d’utilisation.</strong> Le service de mesure interne Nevi Pulse reçoit des événements associés à l’identifiant d’installation : ouverture de l’application, parcours de présentation, étapes de l’écran d’abonnement, formule sélectionnée, résultat d’un achat, autorisation ou refus du rappel, ainsi que des mesures techniques de traduction. Selon la version installée, ils peuvent aussi indiquer les sessions, pages consultées et temps passés au premier plan, boutons utilisés, changements de langue ou de thème, débuts et fins d’enregistrement, étapes de traitement, lecture audio et réponses aux demandes d’autorisation. Ces événements servent à comprendre l’utilisation, mesurer le parcours d’abonnement et diagnostiquer les problèmes. Les événements émis par l’application ne contiennent pas les enregistrements audio, les transcriptions ni les traductions. Les versions disposant d’une file d’envoi locale peuvent conserver jusqu’à 300 événements en attente et tenter de les renvoyer pendant sept jours au maximum, notamment après une coupure réseau.</p>
