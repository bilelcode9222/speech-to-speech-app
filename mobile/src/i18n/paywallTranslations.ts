...
const es: PaywallCopy = {
  ...
  restoreFailedTitle: 'No se pudo restaurar', restoreFailedBody: 'No se pueden restaurar las compras en este momento.', continueLabel: 'Continuar', tryFreeTemplate: '{trial}', then: 'Después',
