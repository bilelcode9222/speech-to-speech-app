...
export function FaceToFaceView({
  ...
  // Le dernier côté qui a lancé l'enregistrement est la source fiable
  // pour savoir où placer l'original et la traduction. C'est indispensable
  // quand la source vaut "auto", car exchange.sourceLanguage vaut alors
  // "auto" quel que soit le côté qui parle.
